...
#define __decl_llvm_target_func_op_intl__(ret_type, export_name, ...)\
	extern ret_type export_name(::sys::llvm::llvm_target target __va_opt_comma__(__VA_ARGS__)\
			__declaration_list__(__decl_llvm_target_func_decl_list_expand_id__(), __VA_ARGS__));
...
#undef __decl_llvm_target_func_expand_id__
#undef __decl_llvm_target_func_decl_list_expand_id__
}
}

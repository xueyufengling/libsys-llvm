...
file(WRITE ${TARGET_LIST_HEADER_FILE}
	...
	"#define __llvm_all_support_target_list__() ${LLVM_ALL_SUPPORT_TARGETS_MACRO}\n\n"
)
# Generate equal macro for all targets
...
foreach(target ${LLVM_ENABLED_TARGETS_LIST})
	list(FIND LLVM_TARGETS_TO_BUILD "${target}" index)
	if(NOT index EQUAL -1)
		message(STATUS "find enabled target: ${target}")
		file(APPEND ${TARGET_LIST_HEADER_FILE}
			"#define __llvm_enable_target_${target}__() 1\n"
		)
	else()
		message(WARNING "enabled target '${target}' not found in LLVM_TARGETS_TO_BUILD")
	endif()
endforeach()
file(APPEND ${TARGET_LIST_HEADER_FILE}
...
foreach(target ${LLVM_ALL_SUPPORT_TARGETS})
	file(WRITE "${CMAKE_CURRENT_SOURCE_DIR}/src/target_func/incl/defs/def_llvm_target_func_${target}.cpp.inc"
		...
		"#if defined(__llvm_enable_target_${target}__)\n"
